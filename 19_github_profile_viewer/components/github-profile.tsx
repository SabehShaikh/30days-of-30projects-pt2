...
export default function GitHubProfileViewer() {
  // State to manage the user input GitHub username
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 py-8">
      <Card className="w-full max-w-3xl p-6 space-y-4 shadow-lg rounded-lg bg-white">
        ...
        <form onSubmit={handleSubmit} className="mb-8 px-6">
          <div className="flex items-center gap-4">
            ...
            >
              {loading ? (
                <ClipLoader className="w-4 h-4 text-white" />
              ) : (
                "Search"
              )}
            </Button>
